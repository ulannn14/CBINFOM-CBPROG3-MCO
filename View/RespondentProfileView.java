...
public class RespondentProfileView extends FrameCanvas{
    ...
    public RespondentProfileView(String name, String email, String username, int[] birthday, int age, int[] dateJoined){
        ...
        updateButton.setBounds(600,420,157,41);
        panel.add(updateButton);
        backButton.setBounds(70,590,100,41);
        panel.add(backButton);
        
        monthsDropdown.setBounds(600,370,130,29);
        panel.add(monthsDropdown);
        daysDropdown.setBounds(740,370,130,29);
        panel.add(daysDropdown);
        yearsDropdown.setBounds(880,370,130,29);
        ...
        usernameField.setBounds(600,300,410,29);
        ...
        usernameFieldLabel.setBounds(600,280,85,20);
        panel.add(usernameFieldLabel);
        birthdayDropdownLabel.setBounds(600,350,85,20);
        panel.add(birthdayDropdownLabel);

        usernameErrorLabel.setBounds(613,330,300237,13);
        usernameErrorLabel.setForeground(Color.RED);
        panel.add(usernameErrorLabel);
        birthdayErrorLabel.setBounds(613,400,300,13);
        birthdayErrorLabel.setForeground(Color.RED);
        panel.add(birthdayErrorLabel);
        updateErrorLabel.setBounds(600,462,300,13);
    ...
    public boolean validateFields(){
        ...
        if (usernameField.getText().length() < 8 || usernameField.getText().length() > 25){
